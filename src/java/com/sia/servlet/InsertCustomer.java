 ...
 * @author AHSMP
 */
@WebServlet(name = "InsertCustomer", urlPatterns = {"/insert_customer"})
public class InsertCustomer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            c.setIdCus(request.getParameter("idcustomer"));
            c.setNamaCus(request.getParameter("namacustomer"));
            c.setAlamatCus(request.getParameter("alamatcustomer"));
            c.setTlpCus((request.getParameter("tlpcustomer")));
            c.setJkCus(Integer.parseInt(request.getParameter("jeniskelamin")));
            c.setStat(request.getParameter("status"));
