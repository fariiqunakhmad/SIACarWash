 ...
 * @author ibnu
 */
@WebServlet(name = "ActionDeletePemasok", urlPatterns = {"/deletepemasok"})
public class ActionDeletePemasok extends HttpServlet {
    
    DBConnection dbc = DBConnection.getInstance();
    Pemasok br  = new Pemasok();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        br.setIdPemasok(request.getParameter("txtid"));
        
        try {
            PemasokQuery mx = new PemasokQuery(dbc.getCon());
            mx.deletePemasok(request.getParameter("txtid"));
