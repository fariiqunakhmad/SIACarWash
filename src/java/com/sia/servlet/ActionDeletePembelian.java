 ...
 * @author ibnu
 */
@WebServlet(name = "ActionDeletePembelian", urlPatterns = {"/deletepembelian"})
public class ActionDeletePembelian extends HttpServlet {
    
    DBConnection dbc = DBConnection.getInstance();
    Pembelian br  = new Pembelian();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        br.setIdPembelian(request.getParameter("txtid"));
        
        try {
            PembelianQuery mx = new PembelianQuery(dbc.getCon());
            mx.deletePembelian(request.getParameter("txtid"));
