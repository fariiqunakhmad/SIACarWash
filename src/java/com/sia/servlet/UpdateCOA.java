 ...
 */
@WebServlet(name = "UpdateCOA", urlPatterns = {"/updateCOA"})
public class UpdateCOA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            cOAq.updateCOA(cOA.getIdCOA(), cOA);
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateCOA</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<br><h1>Servlet UpdateCOA at " + request.getContextPath() + "</h1>");
