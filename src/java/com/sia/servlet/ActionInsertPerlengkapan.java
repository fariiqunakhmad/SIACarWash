 ...
 * @author ibnu
 */
@WebServlet(name = "ActionInsertPerlengkapan", urlPatterns = {"/insertperkap"})
public class ActionInsertPerlengkapan extends HttpServlet {
    
    DBConnection dbc = DBConnection.getInstance();
    Perlengkapan cs =new Perlengkapan();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        cs.setIdPerkap(request.getParameter("txtidperkap"));
        cs.setNamaPerkap(request.getParameter("txtnamaperkap"));
       
        
        try {
            PerlengkapanQuery mx = new PerlengkapanQuery(dbc.getCon());
            mx.simpanPerlengkapan(cs);
        } catch (Exception e) {
