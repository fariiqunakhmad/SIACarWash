<%-- 
    Document   : sidenav
    Created on : Dec 22, 2014, 5:46:38 PM
    ...
    %>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.jsp">Car Wash Accounting Software</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="daftarcoa.jsp">Tabel COA</a>
                                </li>
                                <li>
                                    <a href="daftarjcoa.jsp">Tabel Jenis COA</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
